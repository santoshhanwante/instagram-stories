    ...
    <ScrollView horizontal={true} showsHorizontalScrollIndicator={false} style={styles.container}>
      <View style={styles.storyContainer}>
        <View style={{ position: 'relative' }}>
          <ProfileHead key={0} uri="https://images.unsplash.com/photo-1559629819-638a8f0a4303?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NXx8Ym95fGVufDB8fDB8fHww&auto=format&fit=crop&w=500&q=60" />
          <View style={{
            position: 'absolute',
            right: 10,
            bottom: 15,
